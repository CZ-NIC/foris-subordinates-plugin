...
setup(
    ...
    url="https://gitlab.labs.nic.cz/turris/foris-controller/foris-subordinates-plugin/",
    license="GPL-3.0",
    ...
    dependency_links=[
        "git+https://gitlab.labs.nic.cz/turris/foris-controller/foris-plugins-distutils.git"
